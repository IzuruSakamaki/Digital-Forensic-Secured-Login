  ...
  <?php include 'header.php'; ?>
    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container active" id="hospitals">
        ...
        <form action="file/hospitalReg.php" method="post" enctype="multipart/form-data" onsubmit="doSubmit(1);">
          ...
          <input type="password" name="hpassword" id="hpassword" placeholder="Hospital Password" class="form-control mb-3" required minlength="6">
       ...
       <div class="tab-pane container fade" id="receivers">
         ...
         <form action="file/receiverReg.php" method="post" enctype="multipart/form-data" onsubmit="doSubmit(2);">
          ...
          <input type="password" name="rpassword" id="rpassword" placeholder="Receiver Password" class="form-control mb-3" required minlength="6">
